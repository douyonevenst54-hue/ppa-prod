...
export default function CreatePredictionPage() {
  ...
  if (submitted) {
    return (
      <div style={{ padding: 16, minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
  ...
  return (
    <div style={{ padding: "0 0 80px 0" }}>
      ...
      <div style={{
        ...
        <Link href="/creator" style={{ color: "var(--text-secondary)", textDecoration: "none", fontSize: 20 }}>
          ←
        </Link>
      ...
      <div style={{ padding: 16 }}>
        ...
        <div className="card" style={{ marginBottom: 24 }}>
          ...
          <div style={{ fontSize: 12, color: "var(--text-secondary)", marginBottom: 12 }}>
            Contribute PPA to boost your content visibility
          </div>
          <div style={{ display: "flex", gap: 8 }}>
            {[0, 25, 50, 100].map((amount) => (
              <button
                key={amount}
                onClick={() => setRewardPool(amount)}
                style={{
                  flex: 1,
                  padding: "10px 4px",
                  borderRadius: 10,
